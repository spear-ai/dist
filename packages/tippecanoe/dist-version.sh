#!/usr/bin/env sh
#
# Print the version this checkout releases as: the upstream tippecanoe version,
# plus the Unix timestamp of the current commit as a build revision.
#
...
#
# Ordering works out because the upstream components come first: a 2.80.0 built
# from an older commit still sorts above a later 2.79.0 rebuild.
set -eu
